...
namespace JobPortal.Api.Controllers
{
    ...
    public class PersonalInfoController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<GetAcademicInfoDTO>>> GetPersonalInfosByUserIdAsync(long userId)
        {
            try
            {
                var academicInfoDTOs = await _personalInfoService.GetPersonalInfosByUserIdAsync(userId);
